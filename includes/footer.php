...
?>
                                ...
                                <li><i class="fa fa-phone"></i> +977 <?php  echo $row['MobileNumber'];?></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="footer-widget footer-social">
                            ...
                            <ul class="listnone">                               
                                <li><a href="https://twitter.com/Kakashihatake_4"><i class="fa fa-twitter"></i> Twitter</a></li>
                                <li><a href="https://www.instagram.com/"><i class="fa fa-instagram"></i> Instagram</a></li>
                                <li><a href="https://www.linkedin.com/in/sakar-pudasaini-86b3a9183/"><i class="fa fa-linkedin"></i> Linked In</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>Hamro Salon 2022 @ Sakar Pudasaini</p>
                            </div>
                        </div>
                    </div>
                </div>
